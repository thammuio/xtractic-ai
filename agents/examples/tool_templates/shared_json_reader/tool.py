"""
A simple JSON reader tool that can read JSON files from a given path, relative to the shared workflow directory. The workflow
...
class ToolParameters(BaseModel):
    ...
    """
    filepath: str = Field(description="The local path to the JSON file to read, relative to the workflow directory.")
