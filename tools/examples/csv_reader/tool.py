"""
A simple CSV reader tool that can read CSVs from a given path, relative to the tool's directory. To confirm 
that the tool is working, there is sample data available at data/sample1.csv and data/sample2.csv.
"""
...
class ToolParameters(BaseModel):
    ...
    """
    filepath: str = Field(description="The local path to the CSV file to read, relative to the tool's directory.")
