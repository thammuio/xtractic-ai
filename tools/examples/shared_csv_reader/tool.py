"""
A simple CSV reader tool that can read CSVs from a given path, relative to the shared workflow directory. The workflow
...
class ToolParameters(BaseModel):
    ...
    """
    filepath: str = Field(description="The local path to the CSV file to read, relative to the workflow directory.")
